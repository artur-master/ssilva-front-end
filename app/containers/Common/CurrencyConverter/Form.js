...
export function Form({
  ...
  return (
    <Modal isOpen={isOpen} size="xl" scrollable toggle={onHide}>
      <ModalHeader>Calculadora UF/Peso</ModalHeader>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="d-flex align-items-center mt-2">
                        ...
                        />
                        <div className="btype shadow-sm flex-fill">
                          <IntlFormatCurrency
                            value={converts.toCLP}
                            className="form-control form-control-sm response-input"
                          />
                        </div>
                      </div>
                    </div>
