        ...
        {({values}) => (<>
          ...
          <div className="row background-color-caution" style={{ height: '3rem' }}>
            ...
            <div className="col-md-6 d-flex align-items-center">
              <span className="mx-2 font-14-rem" style={{ width: '9.5em' }}><b>Valor UF</b></span>
              <ExField name="Price" type="number" required />
            </div>
          </div>
          {/* </ModalHeader> */}
          <ModalBody>
              ...
              <div className="p-3 background-color-white">
                <div className="row">
                  <FormGroup className="col-12 col-md-6 my-2">
                    ...
                    <ExField name="BedroomsQuantity" type="select" style={{ width: '13em' }} required >
